 ...
 */
package com.sailthru.android.sdk.impl.external.retrofit.rx.observers;

import java.util.ArrayList;
import java.util.Collections;
import java.util.List;

import com.sailthru.android.sdk.impl.external.retrofit.rx.Notification;
...
public class TestObserver<T> implements Observer<T> {
     ...
     * via {@link #onCompleted}, as a {@link java.util.List}.
     *
    ...
    /**
     * Get the {@link Throwable}s this observer was notified of via {@link #onError} as a {@link java.util.List}.
     *
    ...
    /**
     * Get the sequence of items observed by this observer, as an ordered {@link java.util.List}.
     *
     ...
     *
     * @return a {@link java.util.List} containing one item for each item or notification received by this observer, in
