...
import static com.sailthru.android.sdk.impl.external.retrofit.rx.functions.Functions.alwaysFalse;

import java.util.*;
import java.util.concurrent.*;

import com.sailthru.android.sdk.impl.external.retrofit.rx.exceptions.*;
import com.sailthru.android.sdk.impl.external.retrofit.rx.functions.*;
import com.sailthru.android.sdk.impl.external.retrofit.rx.internal.operators.*;
import com.sailthru.android.sdk.impl.external.retrofit.rx.internal.util.ScalarSynchronousObservable;
import com.sailthru.android.sdk.impl.external.retrofit.rx.observables.*;
import com.sailthru.android.sdk.impl.external.retrofit.rx.observers.SafeSubscriber;
import com.sailthru.android.sdk.impl.external.retrofit.rx.plugins.*;
import com.sailthru.android.sdk.impl.external.retrofit.rx.schedulers.*;
import com.sailthru.android.sdk.impl.external.retrofit.rx.subjects.*;
...
public class Observable<T> {
     ...
     * <p>
     * <em>Note:</em> Use {@link #create(com.sailthru.android.sdk.impl.external.retrofit.rx.Observable.OnSubscribe)} to create an Observable, instead of this constructor,
     * unless you specifically have a need for inheritance.
     * 
     * @param f
     *            {@link com.sailthru.android.sdk.impl.external.retrofit.rx.Observable.OnSubscribe} to be executed when {@link #subscribe(Subscriber)} is called
     */
    ...
    /**
     * @deprecated use {@link #create(com.sailthru.android.sdk.impl.external.retrofit.rx.Observable.OnSubscribe)}
     */
    @Deprecated
    ...
    /**
     * @deprecated use {@link com.sailthru.android.sdk.impl.external.retrofit.rx.Observable.OnSubscribe}
     */
    @Deprecated
    ...
    /**
     * Converts a {@link java.util.concurrent.Future} into an Observable.
     * <p>
     * <img width="640" height="315" src="https://raw.github.com/wiki/Netflix/RxJava/images/rx-operators/from.Future.png">
     * <p>
     * You can convert any object that supports the {@link java.util.concurrent.Future} interface into an Observable that emits the
     * return value of the {@link java.util.concurrent.Future#get} method of that object, by passing the object into the {@code from}
     * method.
     * <p>
     ...
     * 
     * @param future
     *            the source {@link java.util.concurrent.Future}
     * @param <T>
     *            the type of object that the {@link java.util.concurrent.Future} returns, and also the type of item to be emitted by
     *            the resulting Observable
     * @return an Observable that emits the item from the source {@link java.util.concurrent.Future}
    ...
    /**
     * Converts a {@link java.util.concurrent.Future} into an Observable, with a timeout on the Future.
     * <p>
     * <img width="640" height="315" src="https://raw.github.com/wiki/Netflix/RxJava/images/rx-operators/from.Future.png">
     * <p>
     * You can convert any object that supports the {@link java.util.concurrent.Future} interface into an Observable that emits the
     ...
     * @param unit
     *            the {@link java.util.concurrent.TimeUnit} of the {@code timeout} argument
     * @param <T>
     *            the type of object that the {@link java.util.concurrent.Future} returns, and also the type of item to be emitted by
     *            the resulting Observable
     * @return an Observable that emits the item from the source {@link java.util.concurrent.Future}
    ...
    /**
     * Converts a {@link java.util.concurrent.Future}, operating on a specified {@link Scheduler}, into an Observable.
     * <p>
     ...
     * <p>
     * This behaves like {@link #merge(com.sailthru.android.sdk.impl.external.retrofit.rx.Observable)} except that if any of the merged Observables notify of an
     ...
     * <p>
     * This behaves like {@link #merge(com.sailthru.android.sdk.impl.external.retrofit.rx.Observable, com.sailthru.android.sdk.impl.external.retrofit.rx.Observable)} except that if any of the merged Observables
     ...
     * notification from one of them.
     * <p>
     * This behaves like {@link #merge(com.sailthru.android.sdk.impl.external.retrofit.rx.Observable, com.sailthru.android.sdk.impl.external.retrofit.rx.Observable, com.sailthru.android.sdk.impl.external.retrofit.rx.Observable)} except that if any of the merged
     ...
     * notification from one of them.
     * <p>
     * This behaves like {@link #merge(com.sailthru.android.sdk.impl.external.retrofit.rx.Observable, com.sailthru.android.sdk.impl.external.retrofit.rx.Observable, com.sailthru.android.sdk.impl.external.retrofit.rx.Observable, com.sailthru.android.sdk.impl.external.retrofit.rx.Observable)} except that if any of
     ...
     * notification from one of them.
     * <p>
     * This behaves like {@link #merge(com.sailthru.android.sdk.impl.external.retrofit.rx.Observable, com.sailthru.android.sdk.impl.external.retrofit.rx.Observable, com.sailthru.android.sdk.impl.external.retrofit.rx.Observable, com.sailthru.android.sdk.impl.external.retrofit.rx.Observable, com.sailthru.android.sdk.impl.external.retrofit.rx.Observable)} except that
     ...
     * notification from one of them.
     * <p>
     * This behaves like {@link #merge(com.sailthru.android.sdk.impl.external.retrofit.rx.Observable, com.sailthru.android.sdk.impl.external.retrofit.rx.Observable, com.sailthru.android.sdk.impl.external.retrofit.rx.Observable, com.sailthru.android.sdk.impl.external.retrofit.rx.Observable, com.sailthru.android.sdk.impl.external.retrofit.rx.Observable, com.sailthru.android.sdk.impl.external.retrofit.rx.Observable)}
     ...
     * <p>
     * This behaves like
     * {@link #merge(com.sailthru.android.sdk.impl.external.retrofit.rx.Observable, com.sailthru.android.sdk.impl.external.retrofit.rx.Observable, com.sailthru.android.sdk.impl.external.retrofit.rx.Observable, com.sailthru.android.sdk.impl.external.retrofit.rx.Observable, com.sailthru.android.sdk.impl.external.retrofit.rx.Observable, com.sailthru.android.sdk.impl.external.retrofit.rx.Observable, com.sailthru.android.sdk.impl.external.retrofit.rx.Observable)}
     * except that if any of the merged Observables notify of an error via {@link Observer#onError onError},
     * {@code mergeDelayError} will refrain from propagating that error notification until all of the merged
     * Observables have finished emitting items.
     * <p>
     ...
     * notification from one of them.
     * <p>
     * This behaves like {@link #merge(com.sailthru.android.sdk.impl.external.retrofit.rx.Observable, com.sailthru.android.sdk.impl.external.retrofit.rx.Observable, com.sailthru.android.sdk.impl.external.retrofit.rx.Observable, com.sailthru.android.sdk.impl.external.retrofit.rx.Observable, com.sailthru.android.sdk.impl.external.retrofit.rx.Observable, com.sailthru.android.sdk.impl.external.retrofit.rx.Observable, com.sailthru.android.sdk.impl.external.retrofit.rx.Observable, com.sailthru.android.sdk.impl.external.retrofit.rx.Observable)}
     * except that if any of the merged Observables notify of an error via {@link Observer#onError onError},
     * {@code mergeDelayError} will refrain from propagating that error notification until all of the merged
     * Observables have finished emitting items.
     * <p>
     ...
     * notification from one of them.
     * <p>
     * This behaves like {@link #merge(com.sailthru.android.sdk.impl.external.retrofit.rx.Observable, com.sailthru.android.sdk.impl.external.retrofit.rx.Observable, com.sailthru.android.sdk.impl.external.retrofit.rx.Observable, com.sailthru.android.sdk.impl.external.retrofit.rx.Observable, com.sailthru.android.sdk.impl.external.retrofit.rx.Observable, com.sailthru.android.sdk.impl.external.retrofit.rx.Observable, com.sailthru.android.sdk.impl.external.retrofit.rx.Observable, com.sailthru.android.sdk.impl.external.retrofit.rx.Observable, com.sailthru.android.sdk.impl.external.retrofit.rx.Observable)}
     * except that if any of the merged Observables notify of an error via {@link Observer#onError onError},
     * {@code mergeDelayError} will refrain from propagating that error notification until all of the merged
     * Observables have finished emitting items.
     * <p>
     ...
     * @see #throttleWithTimeout(long, java.util.concurrent.TimeUnit)
     */
     ...
     *         newer items
     * @see <a href="https://github.com/Netflix/RxJava/wiki/Filtering-Observables#throttlewithtimeout-or-debounce">RxJava Wiki: debounce()</a>
     * @see #throttleWithTimeout(long, java.util.concurrent.TimeUnit, Scheduler)
     */
     ...
     * @param unit
     *            the {@link java.util.concurrent.TimeUnit} in which {@code period} is defined
    ...
    /**
     * Subscribes to the {@link com.sailthru.android.sdk.impl.external.retrofit.rx.Observable} and receives notifications for each element.
     * <p>
    ...
    /**
     * Subscribes to the {@link com.sailthru.android.sdk.impl.external.retrofit.rx.Observable} and receives notifications for each element and error events.
     * <p>
    ...
    /**
     * Subscribes to the {@link com.sailthru.android.sdk.impl.external.retrofit.rx.Observable} and receives notifications for each element and the terminal events.
     * <p>
     ...
     *
     * @return an {@link com.sailthru.android.sdk.impl.external.retrofit.rx.Observable} that is guaranteed to be well-behaved and to make only serialized calls to
     *         its observers
    ...
    /**
     * Returns a new {@link com.sailthru.android.sdk.impl.external.retrofit.rx.Observable} that multicasts (shares) the original {@link com.sailthru.android.sdk.impl.external.retrofit.rx.Observable}. As long as
     * there is more than 1 {@link Subscriber} this {@link com.sailthru.android.sdk.impl.external.retrofit.rx.Observable} will be subscribed and emitting data.
     * When all subscribers have unsubscribed it will unsubscribe from the source {@link com.sailthru.android.sdk.impl.external.retrofit.rx.Observable}.
     * <p>
     ...
     * 
     * @return a {@link com.sailthru.android.sdk.impl.external.retrofit.rx.Observable} that upon connection causes the source Observable to emit items
     *         to its {@link Observer}s
    ...
    /**
     * Returns an Observable that emits the items in a specified {@link com.sailthru.android.sdk.impl.external.retrofit.rx.Observable} before it begins to emit
     * items emitted by the source Observable.
     * <p>
     ...
     * @return an Observable that emits the items in the specified {@link com.sailthru.android.sdk.impl.external.retrofit.rx.Observable} and then emits the items
     *         emitted by the source Observable
    ...
    /**
     * Subscribes to an Observable and invokes {@link com.sailthru.android.sdk.impl.external.retrofit.rx.Observable.OnSubscribe} function without any contract protection,
     * error handling, unsubscribe, or execution hooks.
     * <p>
     * Use this only for implementing an {@link com.sailthru.android.sdk.impl.external.retrofit.rx.Observable.Operator} that requires nested subscriptions. For other
     ...
     * @see #sample(long, java.util.concurrent.TimeUnit)
     */
     ...
     * @return an Observable that performs the throttle operation
     * @see <a href="https://github.com/Netflix/RxJava/wiki/Filtering-Observables#takelast">RxJava Wiki: throttleLast()</a>
     * @see #sample(long, java.util.concurrent.TimeUnit, Scheduler)
     */
     ...
     *            resulting Observable
     * @param unit
     *            the {@link java.util.concurrent.TimeUnit} of {@code timeout}
     ...
     * @see #debounce(long, java.util.concurrent.TimeUnit)
     */
     ...
     * @return an Observable that filters out items that are too quickly followed by newer items
     * @see <a href="https://github.com/Netflix/RxJava/wiki/Filtering-Observables#throttlewithtimeout-or-debounce">RxJava Wiki: throttleWithTimeout()</a>
     * @see #debounce(long, java.util.concurrent.TimeUnit, Scheduler)
     */
