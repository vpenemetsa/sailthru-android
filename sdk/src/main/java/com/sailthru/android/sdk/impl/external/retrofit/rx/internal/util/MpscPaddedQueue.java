...
import com.sailthru.android.sdk.impl.external.retrofit.rx.internal.util.MpscPaddedQueue.Node;
...
abstract class MpscLinkedQueueHeadRef<E> extends MpscLinkedQueuePad0<E> {
    ...
    private static final AtomicReferenceFieldUpdater<MpscLinkedQueueHeadRef, MpscPaddedQueue.Node> UPDATER =
        newUpdater(MpscLinkedQueueHeadRef.class, MpscPaddedQueue.Node.class, "headRef");
    private volatile MpscPaddedQueue.Node<E> headRef;

    protected final MpscPaddedQueue.Node<E> headRef() {
        return headRef;
    }
    protected final void headRef(MpscPaddedQueue.Node<E> val) {
        headRef = val;
    }
    protected final void lazySetHeadRef(MpscPaddedQueue.Node<E> newVal) {
...
abstract class MpscLinkedQueueTailRef<E> extends MpscLinkedQueuePad1<E> {
    @SuppressWarnings("rawtypes")
    private static final AtomicReferenceFieldUpdater<MpscLinkedQueueTailRef, MpscPaddedQueue.Node> UPDATER =
        newUpdater(MpscLinkedQueueTailRef.class, MpscPaddedQueue.Node.class, "tailRef");
    private volatile MpscPaddedQueue.Node<E> tailRef;
    protected final MpscPaddedQueue.Node<E> tailRef() {
        return tailRef;
    }
    protected final void tailRef(MpscPaddedQueue.Node<E> val) {
        tailRef = val;
    }
    @SuppressWarnings("unchecked")
    protected final MpscPaddedQueue.Node<E> getAndSetTailRef(MpscPaddedQueue.Node<E> newVal) {
        return (MpscPaddedQueue.Node<E>) UPDATER.getAndSet(this, newVal);
    }
}
/**
