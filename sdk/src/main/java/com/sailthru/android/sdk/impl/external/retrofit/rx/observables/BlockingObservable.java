 ...
 */
package com.sailthru.android.sdk.impl.external.retrofit.rx.observables;
...
import com.sailthru.android.sdk.impl.external.retrofit.rx.internal.operators.BlockingOperatorLatest;
import com.sailthru.android.sdk.impl.external.retrofit.rx.internal.operators.BlockingOperatorMostRecent;
import com.sailthru.android.sdk.impl.external.retrofit.rx.internal.operators.BlockingOperatorNext;
import com.sailthru.android.sdk.impl.external.retrofit.rx.internal.operators.BlockingOperatorToFuture;
import com.sailthru.android.sdk.impl.external.retrofit.rx.internal.operators.BlockingOperatorToIterator;
...
public class BlockingObservable<T> {
    ...
    /**
     * Returns an {@link java.util.Iterator} that iterates over all items emitted by this {@code BlockingObservable}.
     * <p>
     * <img width="640" height="315" src="https://github.com/Netflix/RxJava/wiki/images/rx-operators/B.getIterator.png">
     * 
     * @return an {@link java.util.Iterator} that can iterate over the items emitted by this {@code BlockingObservable}
     ...
     * 
     * @param predicate
     *            a predicate function to evaluate items emitted by this {@link com.sailthru.android.sdk.impl.external.retrofit.rx.observables.BlockingObservable}
    ...
    /**
     * Returns a {@link java.util.concurrent.Future} representing the single value emitted by this {@code BlockingObservable}.
     * <p>
     * If {@link com.sailthru.android.sdk.impl.external.retrofit.rx.observables.BlockingObservable} emits more than one item, {@link java.util.concurrent.Future} will receive an
     * {@link IllegalArgumentException}. If {@link com.sailthru.android.sdk.impl.external.retrofit.rx.observables.BlockingObservable} is empty, {@link java.util.concurrent.Future}
     ...
     * 
     * @return a {@link java.util.concurrent.Future} that expects a single item to be emitted by this {@code BlockingObservable}
