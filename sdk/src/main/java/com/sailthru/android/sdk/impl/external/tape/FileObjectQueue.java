...
public class FileObjectQueue<T> implements ObjectQueue<T> {
  ...
  @Override public final void add(T entry) {
    try {
      ...
      throw new com.sailthru.android.sdk.impl.external.tape.FileException("Failed to add entry.", e, file);
    }
  }
  ...
  @Override public T peek() {
    try {
      ...
      throw new com.sailthru.android.sdk.impl.external.tape.FileException("Failed to peek.", e, file);
    }
  }
  ...
  @Override public final void remove() {
    try {
      ...
      throw new com.sailthru.android.sdk.impl.external.tape.FileException("Failed to remove.", e, file);
    }
  }
  ...
  @Override public void setListener(final Listener<T> listener) {
    if (listener != null) {
      try {
        ...
        throw new com.sailthru.android.sdk.impl.external.tape.FileException("Unable to iterate over QueueFile contents.", e, file);
      }
    }
