...
import com.sailthru.android.sdk.impl.external.retrofit.Profiler.RequestInformation;
...
import com.sailthru.android.sdk.impl.external.retrofit.converter.ConversionException;
 ...
 * the request type. The built-in methods are {@link com.sailthru.android.sdk.impl.external.retrofit.http.GET GET},
 * {@link com.sailthru.android.sdk.impl.external.retrofit.http.PUT PUT}, {@link com.sailthru.android.sdk.impl.external.retrofit.http.POST POST}, {@link com.sailthru.android.sdk.impl.external.retrofit.http.HEAD HEAD},
 * and {@link com.sailthru.android.sdk.impl.external.retrofit.http.DELETE DELETE}. You can define your own HTTP method by creating an
 * annotation that takes a {code String} value and itself is annotated with
 * {@link com.sailthru.android.sdk.impl.external.retrofit.http.RestMethod @RestMethod}.
 * <p>
 * Method parameters can be used to replace parts of the URL by annotating them with
 * {@link com.sailthru.android.sdk.impl.external.retrofit.http.Path @Path}. Replacement sections are denoted by an identifier surrounded
 * by curly braces (e.g., "{foo}"). To add items to the query string of a URL use
 * {@link com.sailthru.android.sdk.impl.external.retrofit.http.Query @Query}. If the path or query element has already been URI encoded
 * use {@link com.sailthru.android.sdk.impl.external.retrofit.http.EncodedPath @EncodedPath} or
 * {@link com.sailthru.android.sdk.impl.external.retrofit.http.EncodedQuery @EncodedQuery} to prevent repeated encoding.
 * <p>
 ...
 * {@link com.sailthru.android.sdk.impl.external.retrofit.converter.Converter Converter}. If the callback parameter type uses a wildcard,
 ...
 * {@link com.sailthru.android.sdk.impl.external.retrofit.converter.Converter Converter}.
 * </ul>
 * <p>
 * The body of a request is denoted by the {@link com.sailthru.android.sdk.impl.external.retrofit.http.Body @Body} annotation. The object
 * will be converted to request representation by a call to
 * {@link com.sailthru.android.sdk.impl.external.retrofit.converter.Converter#toBody(Object) toBody} on the supplied
 * {@link com.sailthru.android.sdk.impl.external.retrofit.converter.Converter Converter} for this instance. The body can also be a
 ...
 * annotations:
 * <ul>
 * <li>{@link com.sailthru.android.sdk.impl.external.retrofit.http.FormUrlEncoded @FormUrlEncoded} - Form-encoded data with key-value
 * pairs specified by the {@link com.sailthru.android.sdk.impl.external.retrofit.http.Field @Field} parameter annotation.
 * <li>{@link com.sailthru.android.sdk.impl.external.retrofit.http.Multipart @Multipart} - RFC 2387-compliant multi-part data with parts
 * specified by the {@link com.sailthru.android.sdk.impl.external.retrofit.http.Part @Part} parameter annotation.
 * </ul>
 * <p>
 * Additional static headers can be added for an endpoint using the
 * {@link com.sailthru.android.sdk.impl.external.retrofit.http.Headers @Headers} method annotation. For per-request control over a header
...
public class RestAdapter {
  ...
  public interface Log {
    ...
    /** A {@link com.sailthru.android.sdk.impl.external.retrofit.RestAdapter.Log} implementation which does not log anything. */
    Log NONE = new Log() {
  ...
  /**
   * Build a new {@link com.sailthru.android.sdk.impl.external.retrofit.RestAdapter}.
   * <p>
  ...
  public static class Builder {
    ...
    /** Create the {@link com.sailthru.android.sdk.impl.external.retrofit.RestAdapter} instances. */
