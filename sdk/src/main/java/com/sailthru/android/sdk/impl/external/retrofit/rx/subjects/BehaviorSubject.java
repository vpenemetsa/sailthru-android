 ...
 */
package com.sailthru.android.sdk.impl.external.retrofit.rx.subjects;
...
import com.sailthru.android.sdk.impl.external.retrofit.rx.internal.operators.NotificationLite;
import com.sailthru.android.sdk.impl.external.retrofit.rx.subjects.SubjectSubscriptionManager.SubjectObserver;
...
public final class BehaviorSubject<T> extends Subject<T, T> {
    /**
     * Creates a {@link com.sailthru.android.sdk.impl.external.retrofit.rx.subjects.BehaviorSubject} without a default item.
     *
     * @param <T>
     *            the type of item the Subject will emit
     * @return the constructed {@link com.sailthru.android.sdk.impl.external.retrofit.rx.subjects.BehaviorSubject}
     */
    public static <T> BehaviorSubject<T> create() {
        return create(null, false);
    }
    /**
     * Creates a {@link com.sailthru.android.sdk.impl.external.retrofit.rx.subjects.BehaviorSubject} that emits the last item it observed and all subsequent items to each
     ...
     *            {@link com.sailthru.android.sdk.impl.external.retrofit.rx.subjects.BehaviorSubject} has not yet observed any items from its source {@code Observable}
     * @return the constructed {@link com.sailthru.android.sdk.impl.external.retrofit.rx.subjects.BehaviorSubject}
     */
