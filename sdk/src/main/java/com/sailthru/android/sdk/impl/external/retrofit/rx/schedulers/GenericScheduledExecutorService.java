 ...
 */
package com.sailthru.android.sdk.impl.external.retrofit.rx.schedulers;

import com.sailthru.android.sdk.impl.external.retrofit.rx.Scheduler;
import com.sailthru.android.sdk.impl.external.retrofit.rx.internal.util.RxThreadFactory;
...
/**
 * A default {@link java.util.concurrent.ScheduledExecutorService} that can be used for scheduling actions when a {@link Scheduler} implementation doesn't have that ability.
 * <p>
 * For example if a {@link Scheduler} is given an {@link java.util.concurrent.Executor} or {{@link java.util.concurrent.ExecutorService} instead of {@link java.util.concurrent.ScheduledExecutorService}.
 * <p>
...
/* package */final class GenericScheduledExecutorService {
     ...
     * 
     * @return {@link java.util.concurrent.ScheduledExecutorService} for generic use.
     */
